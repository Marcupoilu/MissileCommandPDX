shopItemsData = 
{
    ...
    ShopItem("Bolter", UnlockCannon("Bolter", gfx.image.new("images/player/cannons/cannon_simpleCannon"), "", nil, table.findByParam(cannonsData, "id", "blaster"),"Starter Weapon : Bolter",100, 0, 4, 1.5),2000, 0, 4, 2),
    ShopItem("Laser",table.findByParam(unlocksData, "name","Laser"),2000, 0, 5, 2),
    ShopItem("Shotgun",table.findByParam(unlocksData, "name","Shotgun"),2000, 0, 5, 2),
    ShopItem("Orbiter",table.findByParam(unlocksData, "name","Orbiter"),3000, 0, 5, 2),
    ShopItem("Launcher",table.findByParam(unlocksData, "name","Launcher"),4000, 0, 5, 2),
    ShopItem("Plasma",table.findByParam(unlocksData, "name","Plasma"),5000, 0, 5, 2),
}