shopItemsData = 
{
    ...
    ShopItem("Damage Up",UnlockPassive("Damage Up", gfx.image.new("images/ui/icons/damageUp"), "", nil, getUpgradePassive("damageBonus"), "+10% Damage Bonus"),800, 0, 5, 2),
    ...
    ShopItem("Regeneration",table.findByParam(unlocksData, "name","Regeneration"),800, 0, 5, 1.5),
    ShopItem("Bullet Piercing",table.findByParam(unlocksData, "name","Bullet Piercing"),1500, 0, 5, 2),
    ShopItem("Duration",table.findByParam(unlocksData, "name","Duration"),800, 0, 5, 2),
    ShopItem("Life+",table.findByParam(unlocksData, "name","Life+"),2000, 0, 5, 2),
    ...
    ShopItem("Omni",table.findByParam(unlocksData, "name","Omni"),2000, 0, 1, 2),
    ShopItem("Bolter Cannon", UnlockCannon("Bolter Cannon", gfx.image.new("images/player/cannons/cannon_simpleCannon"), "", nil, table.findByParam(cannonsData, "id", "blaster"),"Starter Weapon : Bolter",100, 0, 4, 1.5),1500, 0, 4, 2),
    ShopItem("Shotgun Cannon",table.findByParam(unlocksData, "name","Shotgun Cannon"),1500, 0, 5, 2),
