shopItemsData = 
{
    ...
    ShopItem("Laser Cannon",table.findByParam(unlocksData, "name","Laser"),2000, 0, 5, 2),
    ShopItem("Shotgun Cannon",table.findByParam(unlocksData, "name","Shotgun"),2000, 0, 5, 2),
    ShopItem("Orbiter Cannon",table.findByParam(unlocksData, "name","Orbiter"),3000, 0, 5, 2),
    ShopItem("Launcher Cannon",table.findByParam(unlocksData, "name","Launcher"),4000, 0, 5, 2),
    ShopItem("Plasma Cannon",table.findByParam(unlocksData, "name","Plasma"),5000, 0, 5, 2),
}