shopItemsData = 
{
    ...
    ShopItem("Orbiter",table.findByParam(unlocksData, "name","Orbiter"),3000, 0, 5, 1.5),
    ShopItem("Launcher",table.findByParam(unlocksData, "name","Launcher"),4000, 0, 5, 1.5),
    ShopItem("Plasma",table.findByParam(unlocksData, "name","Plasma"),5000, 0, 5, 1.5),
}