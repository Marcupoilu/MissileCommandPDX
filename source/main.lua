...
BulletPool:preload(EnemyMediumOne, 20, 0, 0, 20, 1, 1, 1, gfx.image.new("images/enemies/medium/enemy_medium_01"), 1)
BulletPool:preload(EnemyMediumTwo, 20, 0, 0, 20, 1, 1, 1, gfx.image.new("images/enemies/medium/enemy_medium_02"), 1)
BulletPool:preload(EnemyMediumThree, 20, 0, 0, 20, 1, 1, 1, gfx.image.new("images/enemies/medium/enemy_medium_03"), 1)
BulletPool:preload(EnemyMediumFour, 20, 0, 0, 20, 1, 1, 1, gfx.image.new("images/enemies/medium/enemy_medium_04"), 1)
BulletPool:preload(EnemyMediumFive, 20, 0, 0, 20, 1, 1, 1, gfx.image.new("images/enemies/medium/enemy_medium_05"), 1)
BulletPool:preload(EnemyLargeOne, 20, 0, 0, 20, 1, 1, 1, gfx.image.new("images/enemies/large/enemy_large_01"), 1)
BulletPool:preload(EnemyLargeTwo, 20, 0, 0, 20, 1, 1, 1, gfx.image.new("images/enemies/large/enemy_large_02"), 1)
