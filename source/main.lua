...
function myGameSetUp()
    ...
    local cannonBase = gfx.image.new("cannon_base")
    local cannonGun = gfx.image.new("cannon_gun")
    assert( cannonBase ) -- make sure the image was where we thought
...
function playdate.update()
    ...
    cannonGunSprite:setRotation(crankPosition)
