...
BulletPool:preload(Bullet, 50, 200, 175, 10, 0.7,0, 1, toMilliseconds(3))
BulletPool:preload(BulletSerpentine, 50, 200, 175, 6, 0.3, 0, 1, toMilliseconds(3))
...
BulletPool:preload(BulletRocket, 30, 200, 175, 4, 0, 0, 1, toMilliseconds(3))
...
BulletPool:preload(BulletGuided, 50, 200, 175, 2, 0.5, 0, 1, toMilliseconds(3))
BulletPool:preload(BulletLaserDome, 2, 200, 175, 100, 1, 0, 2, toMilliseconds(3))
BulletPool:preload(BulletOrbital, 50, 200, 175, 50, 1, 0, 1, toMilliseconds(3))
BulletPool:preload(BulletPlasma, 30, 200, 175, 4, 0.75, 0, 1, toMilliseconds(5))
BulletPool:preload(BulletShockwave, 30, 200, 175, 4, 0.25, 0, 1, toMilliseconds(3),3 ,5)
BulletPool:preload(BulletToxicVape, 30, 200, 175, 2, 0.5, 0, 1, toMilliseconds(5),3 ,45, 300,500)
BulletPool:preload(BulletTracer, 6, 200, 175, 5, 0.5, 0, 1, toMilliseconds(4))

BulletPool:preload(Xwing, 20, 0, 0, 20, 1, 1, 1, gfx.image.new("images/enemies/small/enemy_small_01"), 1)
BulletPool:preload(EnemySmallTwo, 20, 0, 0, 20, 1, 1, 1, gfx.image.new("images/enemies/small/enemy_small_02"), 1)
BulletPool:preload(EnemySmallThree, 20, 0, 0, 20, 1, 1, 1, gfx.image.new("images/enemies/small/enemy_small_03"), 1)
BulletPool:preload(EnemySmallFour, 20, 0, 0, 20, 1, 1, 1, gfx.image.new("images/enemies/small/enemy_small_04"), 1)
BulletPool:preload(EnemySmallFive, 20, 0, 0, 20, 1, 1, 1, gfx.image.new("images/enemies/small/enemy_small_05"), 1)
BulletPool:preload(EnemySmallSix, 20, 0, 0, 20, 1, 1, 1, gfx.image.new("images/enemies/small/enemy_small_06"), 1)
BulletPool:preload(EnemySmallSeven, 20, 0, 0, 20, 1, 1, 1, gfx.image.new("images/enemies/small/enemy_small_07"), 1)
BulletPool:preload(EnemySmallEight, 20, 0, 0, 20, 1, 1, 1, gfx.image.new("images/enemies/small/enemy_small_08"), 1)
BulletPool:preload(EnemyMediumOne, 20, 0, 0, 20, 1, 1, 1, gfx.image.new("images/enemies/small/enemy_medium_01"), 1)
BulletPool:preload(EnemyMediumTwo, 20, 0, 0, 20, 1, 1, 1, gfx.image.new("images/enemies/small/enemy_medium_02"), 1)
BulletPool:preload(EnemyMediumThree, 20, 0, 0, 20, 1, 1, 1, gfx.image.new("images/enemies/small/enemy_medium_03"), 1)
BulletPool:preload(EnemyMediumFour, 20, 0, 0, 20, 1, 1, 1, gfx.image.new("images/enemies/small/enemy_medium_04"), 1)
BulletPool:preload(EnemyMediumFive, 20, 0, 0, 20, 1, 1, 1, gfx.image.new("images/enemies/small/enemy_medium_05"), 1)
BulletPool:preload(EnemyLargeOne, 20, 0, 0, 20, 1, 1, 1, gfx.image.new("images/enemies/small/enemy_large_01"), 1)
BulletPool:preload(EnemyLargeTwo, 20, 0, 0, 20, 1, 1, 1, gfx.image.new("images/enemies/small/enemy_large_02"), 1)
BulletPool:preload(EnemyLargeThree, 20, 0, 0, 20, 1, 1, 1, gfx.image.new("images/enemies/small/enemy_large_03"), 1)
BulletPool:preload(EnemyLargeFour, 20, 0, 0, 20, 1, 1, 1, gfx.image.new("images/enemies/small/enemy_large_04"), 1)
