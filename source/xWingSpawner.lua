...
function xWingSpawner:spawn()
    ...
    xWingSpawner.super.spawn(self, Xwing(0, self.y, enemiesData.Xwing.speed, enemiesData.Xwing.hp, enemiesData.Xwing.xp, enemiesData.Xwing.damage, enemiesData.Xwing.core))
end