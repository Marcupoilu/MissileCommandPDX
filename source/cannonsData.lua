function createCannonsData()
    cannonsData = 
    {
        ...
        Cannon("Blaster Cannon", {table.findByParam(weaponsData, "className", "SimpleCannon")}, 0, gfx.image.new("images/player/cannons/cannon_simpleCannon"), gfx.image.new("images/player/bases/base_simpleCannon"), "blaster"),
        Cannon("Laser Cannon", {table.findByParam(weaponsData, "className", "Beam")}, 0, gfx.image.new("images/player/cannons/cannon_beam"),  gfx.image.new("images/player/bases/base_beam"), "beam"),
