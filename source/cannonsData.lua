cannonsData = 
{
    ...
    Cannon("Defender", {table.findByParam(weaponsData, "className", "SimpleCannon")}, {getUpgradePassive("attackSpeedBonus")}, 0, gfx.image.new("images/player/guns/gun_default")),
