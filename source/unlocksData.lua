unlocksData = 
{
    ...
    UnlockCannon("Laser", gfx.image.new("images/ui/icons/beam"), "Reach level 5 with beam", ConditionWeaponLevel("Beam", 5), table.findByParam(cannonsData, "id", "beam"),"Starter Weapon : Beam",100, 0, 1, 1.5),
    UnlockCannon("Orbiter", gfx.image.new("images/ui/icons/orbital"), "Reach level 5 with orbital", ConditionWeaponLevel("Orbital", 5), table.findByParam(cannonsData, "id", "orbital"),"Starter Weapon : Orbital",100, 0, 1, 1.5),
    UnlockCannon("Launcher", gfx.image.new("images/ui/icons/rocket"), "Reach level 5 with rocket", ConditionWeaponLevel("Rocket", 5), table.findByParam(cannonsData, "id", "rocket"),"Starter Weapon : Rocket",100, 0, 1, 1.5),
}