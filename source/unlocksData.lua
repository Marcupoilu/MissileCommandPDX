unlocksData = 
{
    ...
    UnlockPassive("Cooldown-", gfx.image.new("images/ui/icons/cooldown"), "Reach Level 5", Condition("level", 5), getUpgradePassive("attackSpeedBonus"), "-10% Weapons Cooldown"),
    UnlockPassive("XP+", gfx.image.new("images/ui/icons/xpUp"), "Reach Level 10", Condition("level", 10), getUpgradePassive("xpBonus"), "+10% XP Gain"),
    UnlockPassive("Regeneration", gfx.image.new("images/ui/icons/regen"), "Reach Level 10", Condition("level", 10), getUpgradePassive("regenerationRate"),"+10% Regeneration Rate"),
    UnlockPassive("Duration", gfx.image.new("images/ui/icons/duration"), "Reach Level 15", Condition("level", 15), getUpgradePassive("durationBonus"),"+10% Weapons Duration"),
    UnlockPassive("Life Up", gfx.image.new("images/ui/icons/lifeUp"), "Reach Level 15", Condition("level", 15), getUpgradePassive("lives"),"+1 Life (Resurection)"),
    UnlockPassive("Shield", gfx.image.new("images/ui/icons/shield"), "Reach Level 20", Condition("level", 20), getUpgradePassive("shield"),"-1 Damage Taken"),
    UnlockPassive("Reroll", gfx.image.new("images/ui/icons/rerolls"), "Reach Level 20", Condition("level", 20), getUpgradePassive("rerolls"),"+5 Rerolls"),
    UnlockPassive("Omni", gfx.image.new("images/ui/icons/omni"), "Reach Level 30", Condition("level", 30), getUpgradePassiveByName("omni"),"+4% Weapons Damage, Cooldown, Scale And Speed"),
    ...
    UnlockCannon("Laser", gfx.image.new("images/ui/icons/beam"), "Reach level 5 with beam", ConditionWeaponLevel("Beam", 5), table.findByParam(cannonsData, "id", "beam"),"Starter Weapon : Beam"),
    UnlockCannon("Orbiter", gfx.image.new("images/ui/icons/orbital"), "Reach level 5 with orbital", ConditionWeaponLevel("Orbital", 5), table.findByParam(cannonsData, "id", "orbital"),"Starter Weapon : Orbital"),
    UnlockCannon("Launcher", gfx.image.new("images/ui/icons/rocket"), "Reach level 5 with rocket", ConditionWeaponLevel("Rocket", 5), table.findByParam(cannonsData, "id", "rocket"),"Starter Weapon : Rocket"),
}