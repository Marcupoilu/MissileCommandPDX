upgradesData = 
{
    ...
    UpgradeStat({{name="scaleBonus",value=10}}, "+10% projectile \nscale", "images/projectileScale",5,5),
    ...
    UpgradeWeapon("Freezer", "Laser Freezer", "", "images/ui/icons/freezer",10 ,2),
    UpgradeWeapon("Guided", "Guided Missile", "", "images/ui/icons/guided",10 ,4),
    ...
    UpgradeWeapon("Rocket", "Explosive Missile", "", "images/ui/icons/rocket",10, 4 ),
