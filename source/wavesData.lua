...
wavesData =
{
    ...
    },
    {
        ...
        Waves = {
            Wave(--1
            {
                EnemySpawner(math.random(1000,1000), 34, 0, 15, EnemySmallFive, enemiesData.EnemySmallFive),
            }),
            Wave(--2
            {
                EnemySpawner(math.random(1500,1500), 34, 0, 10, Xwing, enemiesData.Xwing),
                EnemySpawner(math.random(1500,1500), 34, 0, 10, EnemySmallFive, enemiesData.EnemySmallFive),
            }),
            Wave(--3
            {
    ...
    },
    {
        ...
        Waves = {
            Wave(--1
            {
                ...
                EnemySpawner(math.random(2000,2000), 34, 0, 15, EnemySmallFive, enemiesData.EnemySmallFive),
            }),
            Wave(--2
            {
