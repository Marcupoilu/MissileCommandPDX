function CreateWeaponsData()
    weaponsData = 
    {
        ...
        SimpleCannon(toMilliseconds(0.5), 200, 175, 7.5, 0.5, 1, 1), -- balanced starter
        Beam(toMilliseconds(3), 200, 175, 120, 0.3, 1, 4, toMilliseconds(4)), -- balanced starter
        ...
        Aura(toMilliseconds(3), 200, 175, 1, 0.2, 1, 1, toMilliseconds(3)), -- to rework collision detection
