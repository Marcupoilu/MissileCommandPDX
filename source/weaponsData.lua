function CreateWeaponsData()
    weaponsData = 
    {
        ...
        Beam(toMilliseconds(4), 200, 175, 200, 0.5, 1, 4, toMilliseconds(1.5)), -- balanced starter
        Wiper(toMilliseconds(15), 200, 175, 1, 3, 1, 1), -- a revoir apres ennemies HP setup
        Plasma(toMilliseconds(7), 200, 175, 6, 0.75, 1, 1, toMilliseconds(5)),  -- balanced starter
