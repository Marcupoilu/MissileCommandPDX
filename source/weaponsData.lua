function CreateWeaponsData()
    weaponsData = 
    {
        ...
        Beam(toMilliseconds(4), 200, 175, 120, 0.5, 1, 4, toMilliseconds(1.5)), -- balanced starter
        ...
        LaserDome(toMilliseconds(5), 200, 175, 100, 1, 1, 2, toMilliseconds(3)), -- balanced starter
