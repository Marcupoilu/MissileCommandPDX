enemiesData = 
{
    ...
    EnemyMediumFour = {speed = 10, hp = 50, xp = 8, damage = 5, enemyImage = gfx.image.new("images/enemies/medium/enemy_medium_04"), core = 8},
    EnemyMediumFive = {speed = 20, hp = 60, xp = 10, damage = 5, enemyImage = gfx.image.new("images/enemies/medium/enemy_medium_05"), core = 8},
    EnemyLargeOne = {speed = 20, hp = 100, xp = 15, damage = 10, enemyImage = gfx.image.new("images/enemies/large/enemy_large_01"), core = 15},
